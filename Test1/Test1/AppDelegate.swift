...
let urlBase: String = "http://labs.docademic.com:3010/api/catalog/country"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initcontroller() {
        ...
        //self.window?.backgroundColor = colorwindow
        self.globalNavigationController = UINavigationController()
        let main = InitViewController(nibName: "InitViewController", bundle: nil)
        self.globalNavigationController.pushViewController(main, animated: true)
